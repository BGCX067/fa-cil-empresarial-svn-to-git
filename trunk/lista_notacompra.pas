...
type
  Tfrmlista_notacompra = class(TForm)
    ...
    qrnota_itemLOTE_FABRICACAO_DATA: TDateTimeField;
...
begin
  ...
  begin
    ...
    FXNOTA.LoadFromFile('\Z5\server\rel\f000088.fr3');
    FXNOTA.ShowReport;
  end;
  ...
  begin
    ...
    FXNOTA.LoadFromFile('\Z5\server\rel\f000088_3.fr3');
    FXNOTA.ShowReport;
  end;
  ...
  begin
    ...
    FXNOTA.LoadFromFile('\Z5\server\rel\f000088_2.fr3');
    FXNOTA.ShowReport;
  end;
  ...
  begin
    ...
    FXNOTA.LoadFromFile('\Z5\server\rel\f000088_4.fr3');
    FXNOTA.ShowReport;
  end;
...
begin
  ...
  if combo_relatorio.ItemIndex = 2 then
  begin
    FXNOTA.LoadFromFile('\Z5\server\rel\f000088_5.fr3');
    FXNOTA.DesignReport;
  end;
