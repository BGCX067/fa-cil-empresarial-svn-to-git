...
uses
  ...
  IBCustomDataSet, IBQuery, IBDatabase, MemDS, DBAccess,  Mask, RzEdit,
...
uses modulo, principal, venda, venda_fechamento, ecf,
  ...
  senha, filial, papelparede, cliente,
  ...
  venda_farma, convenio, produto_farma, log, ecfserver,
  ...
  xloc_csosn, consulta_lote, importa_nfe;
...
begin
  ...
  FXvenda.LoadFromFile('c:\Z5\server\rel\f000110.fr3');
  FXvenda.ShowReport;
end;
...
begin
  ...
  begin
    ...
    frmmodulo.qrrelatorio.fieldbyname('linha6').asstring := IntToStr(frmvenda.qrvenda_produto.RecordCount);
    frmmodulo.qrrelatorio.post;
    FXvenda.LoadFromFile('c:\Z5\server\rel\f000048.fr3');
    FXvenda.ShowReport;
    FXvenda.LoadFromFile('c:\Z5\server\rel\f000049.fr3');
    FXvenda.ShowReport;
  end
  else
  begin
...
begin
  ...
  begin
    ...
    FXvenda.LoadFromFile('c:\Z5\server\rel\f000049.fr3');
    FXvenda.ShowReport;
    FXvenda.LoadFromFile('c:\Z5\server\rel\f000081.fr3');
    FXvenda.ShowReport;
...
begin
  ...
  begin
    ...
    frmmodulo.qrrelatorio.fieldbyname('linha6').asstring := IntToStr(frmvenda.qrvenda_produto.RecordCount);
    frmmodulo.qrrelatorio.post;
    FXvenda.LoadFromFile('c:\Z5\server\rel\f000048_1.fr3');
    FXvenda.ShowReport;
    FXvenda.LoadFromFile('c:\Z5\server\rel\f000049.fr3');
    FXvenda.ShowReport;
...
begin
  ...
  frmmodulo.qrrelatorio.fieldbyname('linha6').asstring := IntToStr(frmvenda.qrvenda_produto.RecordCount);
  frmmodulo.qrrelatorio.post;
  FXvenda.LoadFromFile('c:\Z5\server\rel\f000154.fr3');
  FXvenda.ShowReport;
  if QRCONTASRECEBER.RECORDCOUNT > 0 then
  begin
...
begin
  ...
  frmmodulo.qrrelatorio.post;
  FXvenda.LoadFromFile('c:\Z5\server\rel\f000155.fr3');
  fxvenda.ShowReport;
end;
