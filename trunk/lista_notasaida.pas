...
begin
  ...
  begin
    ...
    FXNOTA.LoadFromFile('\Z5\server\rel\f000089.fr3');
    FXNOTA.ShowReport;
  end;
  ...
  begin
    ...
    FXNOTA.LoadFromFile('\Z5\server\rel\f000089_2.fr3');
    FXNOTA.ShowReport;
  end;
  ...
  begin
    ...
    FXNOTA.LoadFromFile('\Z5\server\rel\f000061_2.fr3');
    FXNOTA.ShowReport;
  end;
  ...
  begin
    ...
    FXNOTA.LoadFromFile('\Z5\server\rel\f000061_3.fr3');
    FXNOTA.ShowReport;
  end;
