...
begin
  ...
  begin
    ...
    frmmodulo.qrrelatorio.fieldbyname('LINHA1').asstring :=
      'RELAÇÃO DE CLIENTES';
    fxcliente.LoadFromFile('\Z5\server\rel\f000001.fr3');
  ...
  begin
    ...
    fxcliente.LoadFromFile('\Z5\server\rel\f000002.fr3');
    fxcliente.ShowReport;
  ...
  begin
    ...
    fxcliente.LoadFromFile('\Z5\server\rel\f000003.fr3');
    fxcliente.ShowReport;
    qrcliente.MasterSource := nil;
    qrcliente.MasterFields := '';
    qrcliente.IndexFieldNames := '';
  ...
  begin
    ...
    fxcliente.LoadFromFile('\Z5\server\rel\f000004.fr3');
    fxcliente.ShowReport;
    qrcliente.MasterSource := nil;
    qrcliente.MasterFields := '';
    qrcliente.IndexFieldNames := '';
  ...
  begin
    ...
    fxcliente.LoadFromFile('\Z5\server\rel\f000006.fr3');
    fxcliente.ShowReport;
  end;
  ...
  begin
    ...
    fxcliente.LoadFromFile('\Z5\server\rel\f000005.fr3');
    fxcliente.ShowReport;
  end;
