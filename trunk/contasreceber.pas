...
uses
  ...
  RxToolEdit, RxCurrEdit, frxExportPDF, UCBase;
...
begin
  ...
  if qrcontasreceber.Fieldbyname('situacao').asinteger = 2 then
  begin
    application.messagebox('Esta conta já foi recebida!', 'Atenção',
      mb_ok + mb_iconerror);
    exit;
  end;
...
begin
  ...
  begin
    ...
    frmPrincipal.logUC('Liquidou Conta Nr: ' + QRCr.Fieldbyname('codvenda')
      .asstring + ' do Cliente: ' + edit1.Text, 3);
    QRCr.next;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      ACBrBoleto1.DirArqRemessa := DirRemessa; // C:\Z5\server\cob\remessa
...
begin
  ...
  begin
    ...
    begin
      ...
      ACBrBoletoFCFR1.NomeArquivo := 'C:\Z5\server\pdf\' +
        NossoNumero + '.pdf';
