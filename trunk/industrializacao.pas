...
uses
  ...
  Mask, rxCurrEdit, maskutils, RXDBCtrl, PageView, Wwdbigrd,
  ...
  ComCtrls, RXCtrls, RzPanel, frxClass, frxDBSet, RxToolEdit;
...
begin
  ...
  fxpedido.LoadFromFile('\Z5\server\rel\F000194.fr3');
  fxpedido.ShowReport;
