...
uses
  ...
  Mask, rxToolEdit, ZAbstractConnection;
  ...
  begin
    ...
    begin
      try
        ...
        texto := PWideChar('Não foi possível conectar no computador: ' + qrpdv.fieldbyname('hostname').asstring + ':' + qrpdv.fieldbyname('caminho').asstring);
