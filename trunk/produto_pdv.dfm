object frmproduto_pdv: Tfrmproduto_pdv
  ...
  object qrpdv: TZQuery
    ...
    Left = 80
    Top = 48
    object qrpdvDESCRICAO: TWideStringField
      FieldName = 'DESCRICAO'
      Size = 15
    end
    object qrpdvCAMINHO: TWideStringField
      FieldName = 'CAMINHO'
      Size = 100
    end
    object qrpdvATUALIZAR: TWideStringField
      FieldName = 'ATUALIZAR'
      Size = 3
    end
    object qrpdvHOSTNAME: TWideStringField
      FieldName = 'HOSTNAME'
    end
    object qrpdvCX: TWideStringField
      FieldName = 'CX'
      Size = 2
    end
  end
