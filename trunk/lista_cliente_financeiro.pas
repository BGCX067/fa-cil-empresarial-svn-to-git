...
CARTA DE COBRANÇA - Registro SPC/SERASA}
  ...
  begin
    ...
    FXCLIENTE.LoadFromFile('\Z5\server\rel\F000056.fr3');
  ...
  begin
    ...
    frmmodulo.qrrelatorio.fieldbyname('LINHA1').asstring := emitente_cidade + FormatDateTime('", "dddd", "d" de "mmmm" de "yyyy', date);
    FXCLIENTE.LoadFromFile('\Z5\server\rel\F000057.fr3');
    FXCLIENTE.ShowReport;
  end;
  ...
  begin
    ...
    frmmodulo.qrrelatorio.fieldbyname('LINHA1').asstring := emitente_cidade + FormatDateTime('", "dddd", "d" de "mmmm" de "yyyy', date);
    FXCLIENTE.LoadFromFile('\Z5\server\rel\F000053.fr3');
    FXCLIENTE.ShowReport;
  end;
  ...
  begin
    ...
    frmmodulo.qrrelatorio.fieldbyname('LINHA1').asstring := emitente_cidade + FormatDateTime('", "dddd", "d" de "mmmm" de "yyyy', date);
    FXCLIENTE.LoadFromFile('\Z5\server\rel\f000054.fr3');
    FXCLIENTE.ShowReport;
  end;
  ...
  begin
    ...
    frmmodulo.qrrelatorio.fieldbyname('LINHA1').asstring := emitente_cidade + FormatDateTime('", "dddd", "d" de "mmmm" de "yyyy', date);
    FXCLIENTE.LoadFromFile('\Z5\server\rel\f000055.fr3');
    FXCLIENTE.ShowReport;
  end;

  if combo_relatorio.Text = 'RESUMO POR CLIENTE' then
  begin
    FXCLIENTE.LoadFromFile('\Z5\server\rel\f000060.fr3');
    FXCLIENTE.ShowReport;
  end;
  ...
  begin
    ...
    FXCLIENTE.LoadFromFile('\Z5\server\rel\f000151.fr3');
    FXCLIENTE.ShowReport;
  end;
