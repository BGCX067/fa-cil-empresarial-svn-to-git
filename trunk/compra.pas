...
type
  Tfrmcompra = class(TForm)
    ...
    qrnota_item_listaDATA: TDateTimeField;
    ...
    qrnota_item_listaLOTE_VALIDADE: TDateTimeField;
    qrnota_item_listaLOTE_FABRICACAO_DATA: TDateTimeField;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        frmmodulo.qrproduto_mov.fieldbyname('controle').AsString := qrnota_item.fieldbyname('codnota').asstring;
