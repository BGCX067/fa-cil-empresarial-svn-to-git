...
uses
  SysUtils,StrUtils , Classes, ZConnection, DB, ZAbstractRODataset, ZAbstractDataset,
  ...
  IBQuery, IBDatabase, DBAccess,  MemDS, ExtCtrls, dialogs,
  ZAbstractConnection, Bde.DBTables, Data.DBXFirebird, Data.FMTBcd,
  Datasnap.DBClient, Datasnap.Provider, Data.SqlExpr, ACBrBoleto,
  ACBrBoletoFCFR, ACBrBase, ZSqlUpdate, ACBrNFe, USincronizaManifestacao; // NeoKeyUnit,frxExportImage,frxExportRTF,
...
type
  Tfrmmodulo = class(TDataModule)
    ...
    qradicDATA_CADASTRO: TDateTimeField;
    qradicDATA_ULTIMACOMPRA: TDateTimeField;
    ...
    qradicRG_EMISSAO: TDateTimeField;
    qradicSEXO: TWideStringField;
    qradicHISTORICO: TBlobField;
    qradicPREVISAO: TDateTimeField;
    ...
    qradic_orcamentoDATA: TDateTimeField;
    ...
    qradic_nota_itemLOTE_VALIDADE: TDateTimeField;
    qradic_nota_itemLOTE_FABRICACAO_DATA: TDateTimeField;
    ...
    qradic2DATA_CADASTRO: TDateTimeField;
    qradic2DATA_ULTIMACOMPRA: TDateTimeField;
    ...
    qradic2RG_EMISSAO: TDateTimeField;
    qradic2SEXO: TWideStringField;
    qradic2HISTORICO: TBlobField;
    qradic2PREVISAO: TDateTimeField;
    ...
    qradic_orcamento_produtoDATA: TDateTimeField;
    ...
    qrdoc_ant_papelDATA_EMISSAO: TDateTimeField;
    ...
    CDSosDETECTADO_DATA: TSQLTimeStampField;
    CDSosDETECTADO_CODTECNICO: TStringField;
    CDSosSITUACAO: TStringField;
    CDSosCONCLUSAO_DATA: TSQLTimeStampField;
    CDSosCONCLUSAO_ENTREGUE: TSQLTimeStampField;
    ...
    QNotasManifesto: TZQuery;
    upNotasManifesto: TZUpdateSQL;
    ACBrNFe1: TACBrNFe;
    QNotasManifestoCOD: TIntegerField;
    QNotasManifestoCHAVE_NOTA: TWideStringField;
    QNotasManifestoDATA_ENTRADA: TDateTimeField;
    QNotasManifestoEMITENTE: TWideStringField;
    QNotasManifestoCNPJ_EMI: TWideStringField;
    QNotasManifestoIE_EMI: TWideStringField;
    QNotasManifestoVALOR_NF: TFloatField;
    QNotasManifestoTIPO_NF: TWideStringField;
    QNotasManifestoSIT_NF: TWideStringField;
    QNotasManifestoSIT_CONF: TWideStringField;
...
uses principal, produto, ecf; //, UProtect
...
var
  ...
  porta, i: Integer;
begin
  EMSincronizacaoMani := False;
    // FUNCAO PARA PROTECAO NEOKEY na versao 2.0 do Athenas
  begin
    // LOGIN
...
{$ENDIF}
  ...
  caminho := '\Z5\server\ini\com.ini'; // Abre o Sistema Atual
