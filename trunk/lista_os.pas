...
uses
  ...
  frxDBSet, frxDesgn, Menus, AdvGlowButton, AdvReflectionImage;
...
begin
  ...
  begin
    ...
    fXOS.LoadFromFile('\Z5\server\rel\f000051.fr3');
    fXOS.ShowReport;
  end;
  ...
  begin
    ...
    fXOS.LoadFromFile('\Z5\server\rel\f000052.fr3');
    fXOS.ShowReport;
  end;
  ...
  begin
    ...
    fXOS.LoadFromFile('\Z5\server\rel\f000051_2.fr3');
    fXOS.ShowReport;
