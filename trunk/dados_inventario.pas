...
uses
  ...
  AdvGlowButton, Vcl.Imaging.jpeg;
...
begin
  ...
  if FileExists('\Z5\server\bd\eDI.inf') then
  begin
    assignfile(txt, '\Z5\server\bd\eDI.inf');
    reset(txt);
...
begin
  ...
  frminventario.fXproduto.LoadFromFile('\Z5\server\rel\f000126.fr3');
