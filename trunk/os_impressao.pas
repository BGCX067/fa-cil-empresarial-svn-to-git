...
begin
  ...
  begin
    ...
    fxos.LoadFromFile('\Z5\server\rel\f000066.fr3');
    //fxos.LoadFromFile('\Z5\server\rel\relatorio.rav');
    fxos.ShowReport;
  end;
  if RAMO = 3 then
  begin
    fxos.LoadFromFile('\Z5\server\rel\f000068.fr3');
    fxos.ShowReport;
  end;
end;
...
begin
  ...
  if RAMO = 1 then
  begin
    fxos.LoadFromFile('\Z5\server\rel\f000065.fr3');
    fxos.ShowReport;
  end;
  if RAMO = 3 then
  begin

    fxos.LoadFromFile('\Z5\server\rel\f000067.fr3');
    fxos.ShowReport;
  end;
end;
