...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        AssignFile(arquivo, 'C:\Z5\server\Logs\ERROBARRAS' + ExtractFileName(OpenDialog1.FileName));
        Rewrite(arquivo)
      ...
      edestino.Text := '';
      edestino.Text := 'C:\Z5\server\Logs\ERROBARRAS' + ExtractFileName(OpenDialog1.FileName);
      CloseFile(arquivo);
      Memo1.Text := '';
      Memo1.Lines.LoadFromFile(edestino.text);
      if Memo1.Text = '' then
