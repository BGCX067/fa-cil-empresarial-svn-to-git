...
uses
  ...
  Mask, maskutils, RXDBCtrl, PageView, wwdbedit,
  ...
  AdvReflectionImage, AdvPanel, RxCurrEdit, RxToolEdit, ResizeKit, UCBase, AdvSmoothPanel,
  Vcl.ToolWin, AdvMenus, W7Labels, dxGDIPlusClasses, QExport4, QExport4Xlsx;
...
type
  Tfrmcliente = class(TForm)
    ...
    Vendedor1: TMenuItem;
    Convnio1: TMenuItem;
    btImprimirServicos: TAdvGlowButton;
    ...
    btExcluiPessoasautorizadas: TAdvGlowButton;
    ...
    qrcontasreceberpgDATA_EMISSAO: TDateTimeField;
    qrcontasreceberpgDATA_VENCIMENTO: TDateTimeField;
    qrcontasreceberpgDATA_PAGAMENTO: TDateTimeField;
    ...
    RzPanel15: TRzPanel;
    Image15: TImage;
    W7ActiveLabel8: TW7ActiveLabel;
    W7ActiveLabel9: TW7ActiveLabel;
...
uses modulo, principal, loc_regiao, regiao, loc_funci,
  ...
  cliente_inicio, xloc_cidade, webcam2, xloc_cnae, CNPJ, uopc;
