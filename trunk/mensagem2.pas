...
procedure Tfrmmensagem2.bsimClick(Sender: TObject);
begin
  resultado_mensagem := 'SIM';
  close;
end;

procedure Tfrmmensagem2.bokClick(Sender: TObject);
begin
 resultado_mensagem := 'OK';
 close;
end;

procedure Tfrmmensagem2.bnaoClick(Sender: TObject);
begin
