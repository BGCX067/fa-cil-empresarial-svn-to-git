...
type
  Tfrmxloc_notafiscal = class(TForm)
    ...
    queryFATURAMENTO_DATA5: TDateTimeField;
    queryFATURAMENTO_DATA6: TDateTimeField;
    ...
    queryFATURAMENTO_DATA7: TDateTimeField;
    queryFATURAMENTO_DATA8: TDateTimeField;
    queryFATURAMENTO_DATA9: TDateTimeField;
