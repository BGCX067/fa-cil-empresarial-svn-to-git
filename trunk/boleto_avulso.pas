...
uses
  ...
  ZAbstractDataset, ZDataset, wwdblook, Menus, RxToolEdit, RxCurrEdit;
...
begin
  ...
  CobreBemX.PadroesBoleto.PadroesBoletoImpresso.CaminhoImagensCodigoBarras := '\Z5\server\cob\CobreBemX\Imagens\';
