object frmNf_cte: TfrmNf_cte
  Left = 290
  Top = 188
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Nota Fiscal | CT-e'
  ClientHeight = 523
  ClientWidth = 745
  Color = clBtnFace
  ...
  object sGroupBox1: TsGroupBox
    ...
    object sGroupBox2: TsGroupBox
      ...
      object cxDBTextEdit4: TcxDBTextEdit
        Left = 8
        Top = 62
        DataBinding.DataField = 'NR_ROMANEIO'
        DataBinding.DataSource = ds1
        TabOrder = 4
        Width = 121
      end
      object cxDBTextEdit5: TcxDBTextEdit
        Left = 136
        Top = 62
        DataBinding.DataField = 'NR_PEDIDO'
        DataBinding.DataSource = ds1
        TabOrder = 5
        Width = 121
      end
      object codedit: TcxDBTextEdit
        Left = 519
        Top = 24
    ...
    object sGroupBox3: TsGroupBox
      ...
      object Label9: TLabel
        ...
        Width = 117
        Height = 13
        Caption = 'Base de C'#225'lcilo do ICMS'
      ...
      object Label11: TLabel
        ...
        Width = 108
        Height = 13
        Caption = 'Base C'#225'lculo ICMS ST'
      end
      ...
      object cxDBTextEdit8: TcxDBTextEdit
        Left = 8
        Top = 22
        DataBinding.DataField = 'BASE_CALC_ICMS'
        DataBinding.DataSource = ds1
        TabOrder = 0
        Width = 121
      end
      ...
      object cxDBTextEdit10: TcxDBTextEdit
        Left = 410
        Top = 22
        DataBinding.DataField = 'VALOR_ICMS_ST'
        DataBinding.DataSource = ds1
        TabOrder = 3
        Width = 121
      end
      object cxDBTextEdit11: TcxDBTextEdit
        Left = 8
        Top = 65
        DataBinding.DataField = 'PESO_TOTAL'
        DataBinding.DataSource = ds1
        TabOrder = 4
        Width = 121
      end
      ...
      object cxDBTextEdit13: TcxDBTextEdit
        Left = 277
        Top = 22
        DataBinding.DataField = 'BASE_CALC_ICMS_ST'
        DataBinding.DataSource = ds1
        TabOrder = 2
        Width = 121
      end
    ...
    object sGroupBox4: TsGroupBox
      ...
      object cxDBTextEdit32: TcxDBTextEdit
        Left = 561
        Top = 72
        DataBinding.DataField = 'numero_retirada'
        DataBinding.DataSource = ds1
        TabOrder = 3
        Width = 99
      end
    ...
    object codcli: TRzDBButtonEdit
      Left = 599
      Top = 242
      Width = 124
      Height = 21
      DataSource = ds1
      DataField = 'CODRETIRADA_DIFERENTE'
      TabOrder = 3
      Visible = False
      OnKeyPress = codcliKeyPress
      AltBtnWidth = 15
      ButtonWidth = 15
      OnButtonClick = codcliButtonClick
    end
    ...
    object DBComboBox1: TDBRadioGroup
      Left = 7
      Top = 230
      Width = 458
      Height = 42
      Caption = 'local de Retirada diferente do endere'#231'o do remetente'
      Columns = 2
      DataField = 'LOCAL_RETIRADA_DIF'
      DataSource = ds1
      Items.Strings = (
        'Sim'
        'Nao')
