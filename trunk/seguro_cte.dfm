object frmseguro_cte: Tfrmseguro_cte
  Left = 499
  Top = 299
  BorderIcons = []
  ...
  object sGroupBox1: TsGroupBox
    ...
    object Label5: TLabel
      ...
      Width = 90
      Height = 13
      Caption = 'Val.Merc. p/ Averb'
      FocusControl = edtvalaverb
    end
    ...
    object edtseguradora: TcxDBTextEdit
      Left = 280
      Top = 45
      DataBinding.DataField = 'NOME_SEGURADORA'
      DataBinding.DataSource = DataSource1
      TabOrder = 1
      Width = 121
    end
    object edtapolice: TcxDBTextEdit
      Left = 16
      Top = 88
      DataBinding.DataField = 'NUMERO_APOLICE'
      DataBinding.DataSource = DataSource1
      TabOrder = 2
      Width = 217
    end
    object edtaverb: TcxDBTextEdit
      Left = 280
      Top = 88
      DataBinding.DataField = 'NUMERO_AVERBACAO'
      DataBinding.DataSource = DataSource1
      TabOrder = 3
      Width = 121
    end
    object edtvalaverb: TcxDBCalcEdit
      Left = 16
      Top = 144
      DataBinding.DataField = 'VALOR_MERC_AVERB'
      DataBinding.DataSource = DataSource1
      TabOrder = 4
      Width = 121
    end
