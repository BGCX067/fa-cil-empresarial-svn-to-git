...
type
  Tfrmcompra_item = class(TForm)
    ...
    qrgrade_entradaDATAVENDA: TDateTimeField;
    ...
    qrgrade_entradaDATACOMPRA: TDateTimeField;
...
uses compra, principal, xloc_produto, modulo, xloc_cfop, xloc_cst,
  ...
  produto_serial_entrada, produto_serial;//, entrada_lote;
...
begin
  ...
  qrgrade_entrada.SQL.Add('select * from C000131 where CODPRODUTO = :CODPRODUTO AND LOTE = :LOTE');
  qrgrade_entrada.ParamByName('CODPRODUTO').AsString := ecodproduto.Text;
  ...
  begin
    ...
    qrgrade_entrada.Close;
    qrgrade_entrada.SQL.Clear;
    qrgrade_entrada.SQL.Add('update C000131 set ESTOQUE =:ESTOQUE where CODPRODUTO = :CODPRODUTO AND LOTE = :LOTE');
    qrgrade_entrada.ParamByName('CODPRODUTO').AsString := ecodproduto.Text;
    qrgrade_entrada.ParamByName('LOTE').AsString := elote.Text;
  ...
  begin
    ...
    qrgrade_entrada.fieldbyname('codigo').asstring := frmPrincipal.codifica('000131');
    qrgrade_entradaCODPRODUTO.AsString := ecodproduto.Text;
