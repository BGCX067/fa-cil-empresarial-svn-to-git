object frmDoc_ante_cte: TfrmDoc_ante_cte
  Left = 348
  Top = 143
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Emissor dos Documentos Anteriores'
  ClientHeight = 550
  ClientWidth = 883
  Color = clBtnFace
  ...
  object sGroupBox1: TsGroupBox
    ...
    object sGroupBox3: TsGroupBox
      ...
      Width = 865
      Height = 167
      Caption = 'Documento de Transporte Anterior em Papel'
      TabOrder = 1
      SkinData.SkinSection = 'GROUPBOX'
      ...
      object wwDBGrid9: TwwDBGrid
        ...
        Selected.Strings = (
          'FILTRO'#9'2'#9#9'F'
          'TIPO_DOC'#9'50'#9'Tipo Doc. Orig'#9'F'#9
          'SERIE'#9'20'#9'S'#233'rie'#9'F'#9
          'SUB_SERIE'#9'20'#9'Subserie'#9'F'#9
          'NUMERO_DOC'#9'2'#9'N'#250'mero Doc Fiscal'#9'F'#9
          'DATA_EMISSAO'#9'18'#9'Data Emiss'#227'o'#9'F'#9)
        IniAttributes.Delimiter = ';;'
        TitleColor = clBtnFace
        FixedCols = 0
        ShowHorzScrollBar = True
        DataSource = dsdoc_papel
        TabOrder = 1
    ...
    object sGroupBox4: TsGroupBox
      ...
      Width = 865
      Height = 186
      Caption = 'Documento de Transporte Anterior Eletr'#244'nicos'
      TabOrder = 2
      SkinData.SkinSection = 'GROUPBOX'
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          'FILTRO'#9'2'#9#9'F'
          'CHAVE_ACESSO'#9'60'#9'Chave Acesso'#9'F'#9)
        IniAttributes.Delimiter = ';;'
        TitleColor = clBtnFace
        FixedCols = 0
        ShowHorzScrollBar = True
        DataSource = dsdoc_nfe
        TabOrder = 1
        TitleAlignment = taLeftJustify
        TitleFont.Charset = DEFAULT_CHARSET
        TitleFont.Color = clWindowText
  ...
  object dsdoc_papel: TDataSource
    DataSet = frmmodulo.qrdoc_ant_papel
    Left = 624
    Top = 228
  end
  object dsdoc_nfe: TDataSource
    DataSet = frmmodulo.qrdoc_ant_nfe
    Left = 656
    Top = 228
  end
