...
uses
  ...
  ZAbstractDataset, ZDataset, wwdblook, Menus, AdvGlowButton, RxToolEdit,
  RxCurrEdit;
...
begin
  ...
  CobreBemX.PadroesBoleto.PadroesBoletoImpresso.CaminhoImagensCodigoBarras := 'c:\Z5\server\cob\CobreBemX\Imagens\';
