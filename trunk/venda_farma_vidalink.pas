...
type
  Tfrmvenda_farma_vidalink = class(TForm)
    ...
    qrautorizaCNPJ: TWideStringField;
    qrautorizaCODCLIENTE: TWideStringField;
    qrautorizaOBS: TWideStringField;
    qrautorizaCPF: TWideStringField;
    qrautorizaCONVENIO: TWideStringField;
    qrautorizaPRE_AUTORIZACAO: TWideStringField;
    qrautorizaAUTORIZACAO: TWideStringField;
    qrautorizaCUPOM: TWideStringField;
    qrautorizaLOTE: TWideStringField;
...
begin
  frmprincipal.CheckCPF1.documento := ecpf.Text;
