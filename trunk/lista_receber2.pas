...
begin
  ...
  begin
    ...
    fxcontas_receber.LoadFromFile('\Z5\server\rel\f000058.fr3');
  ...
  begin
    ...
    fxcontas_receber.LoadFromFile('\Z5\server\rel\f000058_1.fr3');
    fxcontas_receber.ShowReport;
  end;
  ...
  begin
    ...
    frmmodulo.qrrelatorio.fieldbyname('LINHA1').asstring := 'RELATÓRIO DE CONTAS A RECEBER';
    fxcontas_receber.LoadFromFile('\Z5\server\rel\f000059.fr3');
    fxcontas_receber.ShowReport;
  end;
  ...
  begin
    ...
    frmmodulo.qrrelatorio.fieldbyname('LINHA1').asstring := 'RELATÓRIO DE CONTAS A RECEBER';
    fxcontas_receber.LoadFromFile('\Z5\server\rel\f000059_2.fr3');
    fxcontas_receber.ShowReport;
  end;
  ...
  begin
    ...
    fxcontas_receber.LoadFromFile('\Z5\server\rel\f000060.fr3');
    fxcontas_receber.ShowReport;
  end;
  ...
  begin
    ...
    fxcontas_receber.LoadFromFile('\Z5\server\rel\f000062.fr3');
    fxcontas_receber.ShowReport;
  end;
  ...
  begin
    ...
    fxcontas_receber.LoadFromFile('\Z5\server\rel\f000070.fr3');
    fxcontas_receber.ShowReport;
  end;
