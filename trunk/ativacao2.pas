...
uses
  ...
  AdvShapeButton, AdvGlowButton, jpeg, sLabel, //rxAnimate, rxGIFCtrl,
  AdvReflectionImage;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        application.messagebox('Sistema Ativado com sucesso!', 'Sistema iCloud!', mb_ok + MB_ICONINFORMATION);
        continuacao := false;
      ...
      begin
        if dias = '00' then
        begin
          application.messagebox('Sistema Ativado com sucesso!', 'Sistma iCloud', mb_ok + MB_ICONINFORMATION);
          continuacao := false;
