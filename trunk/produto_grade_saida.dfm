object frmproduto_grade_saida: Tfrmproduto_grade_saida
  ...
  object qrgrade_saida: TZQuery
    ...
    Left = 168
    Top = 120
    object qrgrade_saidaCODIGO: TWideStringField
      FieldName = 'CODIGO'
      Required = True
      Size = 6
    end
    object qrgrade_saidaCODPRODUTO: TWideStringField
      FieldName = 'CODPRODUTO'
      Size = 6
    end
    object qrgrade_saidaCODNOTA: TWideStringField
      FieldName = 'CODNOTA'
      Size = 6
    end
    ...
    object qrgrade_saidaCODGRADE: TWideStringField
      FieldName = 'CODGRADE'
      Size = 6
    end
    object qrgrade_saidaCODITEM: TWideStringField
      FieldName = 'CODITEM'
      Size = 6
    end
