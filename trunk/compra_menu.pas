...
uses
  ...
  frxDesgn, ExtCtrls, RxToolEdit, UCBase;
...
type
  Tfrmcompra_menu = class(TForm)
    ...
    qrfornecedor2DATA: TDateTimeField;
...
//            FRMMODULO.QRPRODUTO_MOV.SQL.ADD('DELETE FROM C000032 WHERE CODLANCAMENTO = '''
//            +qrnota_item.FIELDBYNAME('CODLANCAMENTO').ASSTRING+'''');

            //incluso controle para excluir a nota de entrada // Valtenci 25.02.2014
            FRMMODULO.QRPRODUTO_MOV.SQL.ADD('DELETE FROM C000032 WHERE CONTROLE = '''
