object frmInfcarga_cte: TfrmInfcarga_cte
  Left = 417
  Top = 251
  BorderIcons = []
  ...
  object sGroupBox1: TsGroupBox
    ...
    object edttipo: TcxDBTextEdit
      Left = 8
      Top = 96
      DataBinding.DataField = 'TIPO_MEDIDA'
    ...
    object combocodunidade: TDBComboBox
      Left = 9
      Top = 51
      Width = 368
      Height = 21
      DataField = 'COD_UNIDADE_MED'
