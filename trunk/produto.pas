...
uses
  ...
  RzPanel, AdvReflectionImage, ACBrBarCode, RxToolEdit, RxCurrEdit,
...
type
  Tfrmproduto = class(TForm)
    ...
    qrproduto_locCODIGO: TWideStringField;
    qrproduto_locCODBARRA: TWideStringField;
    qrproduto_locPRODUTO: TWideStringField;
    qrproduto_locUNIDADE: TWideStringField;
    qrproduto_locDATA_CADASTRO: TDateTimeField;
    qrproduto_locCODGRUPO: TWideStringField;
    qrproduto_locCODSUBGRUPO: TWideStringField;
    qrproduto_locCODFORNECEDOR: TWideStringField;
    qrproduto_locCODMARCA: TWideStringField;
    qrproduto_locDATA_ULTIMACOMPRA: TDateTimeField;
    qrproduto_locNOTAFISCAL: TWideStringField;
    qrproduto_locPRECOCUSTO: TFloatField;
    qrproduto_locPRECOVENDA: TFloatField;
    qrproduto_locDATA_ULTIMAVENDA: TDateTimeField;
    qrproduto_locESTOQUE: TFloatField;
    qrproduto_locESTOQUEMINIMO: TFloatField;
    qrproduto_locCODALIQUOTA: TWideStringField;
    qrproduto_locAPLICACAO: TMemoField;
    qrproduto_locLOCALICAZAO: TWideStringField;
    qrproduto_locPESO: TFloatField;
    qrproduto_locVALIDADE: TWideStringField;
    qrproduto_locCOMISSAO: TFloatField;
    qrproduto_locUSA_BALANCA: TIntegerField;
    qrproduto_locUSA_SERIAL: TIntegerField;
    qrproduto_locUSA_GRADE: TIntegerField;
    qrproduto_locCODRECEITA: TWideStringField;
    qrproduto_locFOTO: TWideStringField;
    qrproduto_locDATA_ULTIMACOMPRA_ANTERIOR: TDateTimeField;
    qrproduto_locNOTAFISCAL_ANTERIOR: TWideStringField;
    qrproduto_locCODFORNECEDOR_ANTERIOR: TWideStringField;
    qrproduto_locPRECOCUSTO_ANTERIOR: TFloatField;
    qrproduto_locPRECOVENDA_ANTERIOR: TFloatField;
    qrproduto_locCUSTOMEDIO: TFloatField;
    qrproduto_locAUTO_APLICACAO: TWideStringField;
    qrproduto_locAUTO_COMPLEMENTO: TWideStringField;
    qrproduto_locDATA_REMARCACAO_CUSTO: TDateTimeField;
    qrproduto_locDATA_REMARCACAO_VENDA: TDateTimeField;
    qrproduto_locPRECO_PROMOCAO: TFloatField;
    qrproduto_locDATA_PROMOCAO: TDateTimeField;
    qrproduto_locFIM_PROMOCAO: TDateTimeField;
    qrproduto_locCST: TWideStringField;
    qrproduto_locCLASSIFICACAO_FISCAL: TWideStringField;
    qrproduto_locNBM: TWideStringField;
    qrproduto_locNCM: TWideStringField;
    qrproduto_locALIQUOTA: TFloatField;
    qrproduto_locIPI: TFloatField;
    qrproduto_locREDUCAO: TFloatField;
    qrproduto_locQTDE_EMBALAGEM: TFloatField;
    qrproduto_locTIPO: TWideStringField;
    qrproduto_locPESO_LIQUIDO: TFloatField;
    qrproduto_locFARMACIA_CONTROLADO: TWideStringField;
    qrproduto_locFARMACIA_APRESENTACAO: TIntegerField;
    qrproduto_locFARMACIA_REGISTRO_MEDICAMENTO: TWideStringField;
    qrproduto_locFARMACIA_PMC: TFloatField;
    qrproduto_locULTIMA_ALTERACAO: TDateTimeField;
    qrproduto_locULTIMA_CARGA: TDateTimeField;
    qrproduto_locDATA_INVENTARIO: TDateTimeField;
    qrproduto_locCUSTO_INVENTARIO: TFloatField;
    qrproduto_locESTOQUE_INVENTARIO: TFloatField;
    qrproduto_locESTOQUE_ANTERIOR: TFloatField;
    qrproduto_locPRECOVENDA_NOVO: TFloatField;
    qrproduto_locUSA_RENTABILIDADE: TIntegerField;
    qrproduto_locQUANTIDADE_MINIMA_FAB: TFloatField;
    qrproduto_locAPRESENTACAO: TWideStringField;
    qrproduto_locSITUACAO: TIntegerField;
    qrproduto_locPRECOVENDA1: TFloatField;
    qrproduto_locPRECOVENDA2: TFloatField;
    qrproduto_locPRECOVENDA3: TFloatField;
    qrproduto_locPRECOVENDA4: TFloatField;
    qrproduto_locPRECOVENDA5: TFloatField;
    qrproduto_locDESCONTO_PRECOVENDA: TFloatField;
    qrproduto_locDATA_INVENTARIO_ATUAL: TDateTimeField;
    qrproduto_locCUSTO_INVENTARIO_ATUAL: TFloatField;
    qrproduto_locESTOQUE_INVENTARIO_ATUAL: TFloatField;
    qrproduto_locMARGEM_MINIMA: TFloatField;
    qrproduto_locPISCOFINS: TWideStringField;
    qrproduto_locREFERENCIA_FORNECEDOR: TWideStringField;
    qrproduto_locCOMISSAO1: TFloatField;
    qrproduto_locMARGEM_DESCONTO: TFloatField;
    qrproduto_locTAMANHO: TWideStringField;
    qrproduto_locCOR: TWideStringField;
    qrproduto_locINCIDENCIA_PISCOFINS: TWideStringField;
    qrproduto_locVEIC_CHASSI: TWideStringField;
    qrproduto_locVEIC_SERIE: TWideStringField;
    qrproduto_locVEIC_POTENCIA: TWideStringField;
    qrproduto_locVEIC_PESO_LIQUIDO: TWideStringField;
    qrproduto_locVEIC_PESO_BRUTO: TWideStringField;
    qrproduto_locVEIC_TIPO_COMBUSTIVEL: TWideStringField;
    qrproduto_locVEIC_RENAVAM: TWideStringField;
    qrproduto_locVEIC_ANO_FABRICACAO: TIntegerField;
    qrproduto_locVEIC_ANO_MODELO: TIntegerField;
    qrproduto_locVEIC_TIPO: TWideStringField;
    qrproduto_locVEIC_TIPO_PINTURA: TWideStringField;
    qrproduto_locVEIC_COD_COR: TWideStringField;
    qrproduto_locVEIC_COR: TWideStringField;
    qrproduto_locVEIC_VIN: TWideStringField;
    qrproduto_locVEIC_NUMERO_MOTOR: TWideStringField;
    qrproduto_locVEIC_CMKG: TWideStringField;
    qrproduto_locVEIC_CM3: TWideStringField;
    qrproduto_locVEIC_DISTANCIA_EIXO: TWideStringField;
    qrproduto_locVEIC_COD_MARCA: TWideStringField;
    qrproduto_locVEIC_ESPECIE: TWideStringField;
    qrproduto_locVEIC_CONDICAO: TWideStringField;
    qrproduto_locLOTE_FABRICACAO: TWideStringField;
    qrproduto_locLOTE_VALIDADE: TDateTimeField;
    qrproduto_locMARGEM_AGREGADA: TFloatField;
    qrproduto_locCODBARRA_NOVARTIS: TWideStringField;
    qrproduto_locFARMACIA_DCB: TWideStringField;
    qrproduto_locFARMACIA_ABCFARMA: TWideStringField;
    qrproduto_locFARMACIA_APRESENTACAO_CAIXA: TWideStringField;
    qrproduto_locFARMACIA_PRINCIPIOATIVO: TWideStringField;
    qrproduto_locULTIMA_COMPRA: TDateTimeField;
    qrproduto_locFARMACIA_DATAVIGENCIA: TDateTimeField;
    qrproduto_locFARMACIA_TIPO: TWideStringField;
    qrproduto_locUSA_COMBUSTIVEL: TWideStringField;
    qrproduto_locREFERENCIA: TWideStringField;
    qrproduto_locPERDA: TFloatField;
    qrproduto_locCOMPOSICAO1: TWideStringField;
    qrproduto_locCOMPOSICAO2: TWideStringField;
    qrproduto_locIAT: TWideStringField;
    qrproduto_locIPPT: TWideStringField;
    qrproduto_locSITUACAO_TRIBUTARIA: TWideStringField;
    qrproduto_locFLAG_SIS: TWideStringField;
    qrproduto_locFLAG_ACEITO: TWideStringField;
    qrproduto_locFLAG_EST: TWideStringField;
    qrproduto_locCSOSN: TWideStringField;
    qrproduto_locCODORIGINAL: TWideStringField;
    qrproduto_locCUSTO_ATACADO: TFloatField;
    qrproduto_locUNIDADE_ATACADO: TWideStringField;
    qrproduto_locQTDE_EMBALAGEMATACADO: TFloatField;
    qrproduto_locPMARGEM1: TFloatField;
    qrproduto_locPMARGEM2: TFloatField;
    qrproduto_locPMARGEM3: TFloatField;
    qrproduto_locPMARGEM4: TFloatField;
    qrproduto_locPMARGEM5: TFloatField;
    qrproduto_locPMARGEMATACADO1: TFloatField;
    qrproduto_locPMARGEMATACADO2: TFloatField;
    qrproduto_locPMARGEMATACADO3: TFloatField;
    qrproduto_locPMARGEMATACADO4: TFloatField;
    qrproduto_locPMARGEMATACADO5: TFloatField;
    qrproduto_locPMARGEMATACADO6: TFloatField;
    qrproduto_locPRECOATACADO1: TFloatField;
    qrproduto_locPRECOATACADO2: TFloatField;
    qrproduto_locPRECOATACADO3: TFloatField;
    qrproduto_locPRECOATACADO4: TFloatField;
    qrproduto_locPRECOATACADO5: TFloatField;
    qrproduto_locIND_CFOP: TWideStringField;
    qrproduto_locCFOP_DESC: TWideStringField;
    qrproduto_locUSA_LOTE: TIntegerField;
    qrproduto_locIND_CFOP_VENDA_DENTRO: TWideStringField;
    qrproduto_locIND_CFOP_VENDA_FORA: TWideStringField;
    qrproduto_locIND_CFOP_DEVOLUCAO_DENTRO: TWideStringField;
    qrproduto_locIND_CFOP_DEVOLUCAO_FORA: TWideStringField;
    qrproduto_locIND_CFOP_GARANTIA_DENTRO: TWideStringField;
    qrproduto_locIND_CFOP_GARANTIA_FORA: TWideStringField;
    qrproduto_locCODCONTA: TWideStringField;
    ...
    RzPanel7: TRzPanel;
    Image21: TImage;
    W7ActiveLabel6: TW7ActiveLabel;
    RzPanel8: TRzPanel;
    Image22: TImage;
    W7ActiveLabel7: TW7ActiveLabel;
    RzPanel9: TRzPanel;
    Image23: TImage;
    RzPanel10: TRzPanel;
    Image24: TImage;
    ...
    RzPanel11: TRzPanel;
    Image25: TImage;
    W7ActiveLabel10: TW7ActiveLabel;
    RzPanel12: TRzPanel;
    Image26: TImage;
    W7ActiveLabel11: TW7ActiveLabel;
    RzPanel13: TRzPanel;
    Image27: TImage;
    W7ActiveLabel12: TW7ActiveLabel;
    RzPanel14: TRzPanel;
    Image28: TImage;
    W7ActiveLabel13: TW7ActiveLabel;
    W7ActiveLabel544: TW7ActiveLabel;
    W7ActiveLabel5001: TW7ActiveLabel;
    W7ActiveLabel5222: TW7ActiveLabel;
    ACBrBar: TACBrBarCode;
...
begin
  try
    ...
    begin
      Showmessage
        ('O subgrupo a qual este produto pertence não possue grade! Favor verificar!');
    end;
  except
  end;
end;
  ...
  begin
    case FRMMODULO.qrserial_produto.FieldByName('situacao').asinteger of
      1:
        begin
          if application.messagebox
            ('Tem certeza que deseja BAIXAR este serial do Estoque?', 'Atenção',
      ...
      2:
        begin
          Showmessage
            ('Este serial já foi vendido! Impossível BAIXAR/RETORNAR o mesmo!');
        end;
      3:
        begin
          if application.messagebox
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        application.messagebox
          ('Este produto utiliza grade de preços, impossível usar controle de seriais!',
          'Atenção', mb_ok + mb_iconwarning);
...
begin
  ...
  begin
   ...
   ACBrBar.Text := COMBOCODBARRA.Text;
  end;
  ...
  begin
    ...
    begin
      ...
      if egrupo.Text <> '000000' then
        ...
        then
        begin
          application.messagebox('Grupo não cadastrado!', 'Atenção',
            mb_ok + mb_iconerror);
          egrupo.SetFocus;
          exit;
        end
...
begin
  ...
  begin
    application.messagebox
      ('Este produto não utiliza rentabilidade! Favor verificar!', 'Atenção',
      mb_ok + mb_iconerror);
    exit;
  end;
    ...
    begin
      ...
      begin
        ...
        { if nivel_usuario < 4 then
          begin
          application.messagebox('Seu nível não permite este acesso!',
          'Atenção', mb_ok + mb_iconwarning);
          PageView1.ActivePageindex := 0;
          exit;
          end; }
...
begin
  ...
  begin
    ...
    application.messagebox
      ('Produto Não Esta em Edição, Verifique! Impossível alterar preços!',
      'Atenção', mb_ok + mb_iconwarning);
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if application.messagebox
          ('A somatório do Estoque da Grade está MENOR que o Estoque atual do Produto! Deseja corrigir?',
          'Atenção!', mb_yesno + mb_iconwarning) = idyes then
        begin
          abort;
        end;
      ...
      begin
        if application.messagebox
          ('A somatório do Estoque da Grade está MAIOR que o Estoque atual do Produto! Deseja corrigir?',
          'Atenção!', mb_yesno + mb_iconwarning) = idyes then
        begin
          abort;
        end;
...
begin
  ...
  begin
    ...
    application.messagebox('Não Há Alteração de Preços para Hoje, verifique!',
      'Atenção', mb_ok + mb_iconwarning);
...
begin
  ...
  begin
    if application.messagebox
      ('Deseja Atualiza os preços de venda remarcados hoje?', 'Atenção',
      mb_yesno + mb_iconwarning) = idyes then
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        application.messagebox
          ('Este produto utiliza controle de seriais! Impossível usar grade!',
          'Atenção', mb_ok + mb_iconwarning);
...
begin
  ...
  begin
    ...
    if application.messagebox
      (pchar('Deseja Atualizar os Produtos do Grupo Remarcação ' +
      vcod_remarcacao + ' ?'), 'Atenção', mb_yesno + mb_iconwarning) = idyes
    then
    begin
      ptermometro.visible := True;
...
begin
  ...
  begin
    ...
    if application.messagebox('Confirma a exclusão do serial?', 'Excluir',
      mb_yesno + mb_iconwarning) = idyes then
    begin
      if FRMMODULO.qrserial_produto.FieldByName('codnota').AsString <> 'AVULSO'
      then
      begin
        application.messagebox('Este serial não pode ser excluído!', 'Atenção',
          mb_ok + mb_iconerror);
        exit;
      end;
  ...
  begin
    ...
    begin
      ...
      if eNCM.Text <> '000000' then
        ...
        begin
          application.messagebox('NCM não encontrado!', 'Atenção',
            mb_ok + mb_iconerror);
          eNCM.SetFocus;
          exit;
        end
  ...
  begin
    ...
    begin
      ...
      if ecsosn.Text <> '000' then
        ...
        then
        begin
          application.messagebox('CSOSN não cadastrada!', 'Atenção',
            mb_ok + mb_iconerror);
          ecsosn.SetFocus;
          exit;
        end
