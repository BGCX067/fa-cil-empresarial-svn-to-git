  ...
  begin
    ...
    begin
      if Application.messagebox
        ('Este conhecimento está CANCELADO! Deseja ativá-lo?', 'Atenção',
...
begin
  ...
  begin
    Application.messagebox('Favor informar o Número!', 'Erro',
      mb_ok + mb_iconerror);
    DBEdit2.setfocus;
    exit;
  end;
  ...
  begin
    Application.messagebox('Favor informar o destinatário!', 'Erro',
      mb_ok + mb_iconerror);
...
begin
  ...
  begin
    ...
    then
    begin
      Application.messagebox('Não Informado o Valor da Nota Fiscal, Verifique!',
    ...
    try
      ...
      begin
        ...
        frmMsg_Operador.lb_msg.Caption :=
          'Erro ao Criar XML do CT-e.:Funções Envolvidas:' + #13 +
...
{$ELSE}
      ...
      Label132.Caption := 'Informe o número de série do certificado'#13 +
...
{$ENDIF}
  ...
  begin
    ...
    case frmmodulo.qrconhecimento.fieldbyname('CTE_SITUACAO').AsInteger of
      ...
      4:
        begin // validada
          if Application.messagebox
            ('Este CT-e já foi validado! Deseja prosseguir?', 'Atenção',
      ...
      5:
        begin // transmitida
          if Application.messagebox
            ('Este CT-e já foi validado e transmitido! Deseja prosseguir?',
      ...
      6:
        begin // Aceita
          if Application.messagebox
            ('Este CT-e já foi validado/aceito pela receita! Deseja prosseguir?',
            'Atenção', mb_yesno + MB_ICONWARNING + MB_DEFBUTTON2) = idno then
            exit;
        end;
      ...
      7:
        begin // rejeitada
          if Application.messagebox
            ('Este CT-e já foi validado e rejeitado! Deseja prosseguir?',
            'Atenção', mb_yesno + MB_ICONWARNING + MB_DEFBUTTON2) = idno then
            exit;
        end;
      8:
        begin // cancelada
          Application.messagebox('Este CT-e já foi cancelado!', 'Erro',
            mb_ok + mb_iconerror);
          exit;
        end;
    end;
  ...
  begin
    ...
    dacte.Sistema := 'Sistema: Controle de Conhecimentos Versão: 4.0';
    dacte.Site := trim(frmmodulo.qremitenteHOMEPAGE.text);
    dacte.TipoDACTE := tiRetrato;
    dacte.Usuario := 'Usuário: ' + frmprincipal.iCloud.CurrentUser.UserName;
    Cte.Configuracoes.Certificados.NumeroSerie := edtNumSerie.text;
    pficha.ActivePageIndex := 0;
    PageView2.ActivePageIndex := 0;
  end;
      ...
      begin
        ...
        begin
          ...
          frmMsg_Operador.lb_msg.Caption := 'Erro ao enviar xml do CT-e!!!' +
            #13 + 'Mensagem: ' + 'Reveja suas configurações de email';
          frmMsg_Operador.showmodal;
          exit;
        end;
