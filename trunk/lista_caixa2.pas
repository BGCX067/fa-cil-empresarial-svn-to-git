...
begin
  ...
  begin
    ...
    fxcAIXA.LoadFromFile('\Z5\server\rel\f000071.fr3');
    fxcAIXA.ShowReport;
  end;
  ...
  begin
    ...
    fxcAIXA.LoadFromFile('\Z5\server\rel\f000071_1.fr3');
    fxcAIXA.ShowReport;
  end;
  ...
  begin
    ...
    fxcAIXA.LoadFromFile('\Z5\server\rel\f000072.fr3');
    fxcAIXA.ShowReport;
  end;
  ...
  begin
    ...
    fxcAIXA.LoadFromFile('\Z5\server\rel\f000073.fr3');
    fxcAIXA.ShowReport;
  end;
