...
uses
  ...
  Mask, maskutils, RXDBCtrl, PageView, AdvGlowButton,
  wwdbedit, Wwdotdot, Wwdbcomb, RxToolEdit;
...
begin
  ...
  begin
    ...
    begin
      texto := PWideChar('Existe uma marca/fabricante cadastrado com este nome!' + #13 +
