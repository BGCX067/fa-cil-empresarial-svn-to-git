...
type
  Tfrmfornecedor_compras = class(TForm)
    ...
    qrcomprasLOTE_VALIDADE: TDateTimeField;
    qrcomprasLOTE_FABRICACAO_DATA: TDateTimeField;
    ...
    qrcomprasDATA_CADASTRO: TDateTimeField;
    ...
    qrcomprasDATA_ULTIMACOMPRA_ANTERIOR: TDateTimeField;
    ...
    qrcomprasDATA_REMARCACAO_CUSTO: TDateTimeField;
    qrcomprasDATA_REMARCACAO_VENDA: TDateTimeField;
    qrcomprasPRECO_PROMOCAO: TFloatField;
    qrcomprasDATA_PROMOCAO: TDateTimeField;
    qrcomprasFIM_PROMOCAO: TDateTimeField;
    ...
    qrcomprasULTIMA_ALTERACAO: TDateTimeField;
    qrcomprasULTIMA_CARGA: TDateTimeField;
    qrcomprasDATA_INVENTARIO: TDateTimeField;
    ...
    qrcomprasDATA_INVENTARIO_ATUAL: TDateTimeField;
    ...
    qrcomprasLOTE_VALIDADE_1: TDateTimeField;
    ...
    qrcomprasULTIMA_COMPRA: TDateTimeField;
    qrcomprasFARMACIA_DATAVIGENCIA: TDateTimeField;
