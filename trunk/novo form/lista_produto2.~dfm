object frmlista_produto2: Tfrmlista_produto2
  ...
  object combo_relatorio: TComboBox
    ...
    OnExit = combo_relatorioExit
    OnKeyPress = DateEdit1KeyPress
    Items.Strings = (
      'RELA'#199#195'O DE ESTOQUE - SINT'#201'TICA'
      'RELA'#199#195'O DE ESTOQUE SINT'#201'TICA - DEP'#211'SITO'
      'RELA'#199#195'O DE ESTOQUE SINT'#201'TICA - EXPOSITOR'
      'RELA'#199#195'O DE ESTOQUE SINT'#201'TICA - CONVENI'#202'NCIA'
      'RELA'#199#195'O GERAL DE ESTOQUE - SINT'#201'TICA'
      ...
      'RELA'#199#195'O DE ESTOQUE  FISCAL - SINT'#201'TICA'
      'RELA'#199#195'O DE PRE'#199'OS COM MARK-UP'
      'RELA'#199#195'O DE ESTOQUE POR QUANTIDADE - SINT'#201'TICA')
  end
  ...
  object rxqte1: TRxCalcEdit
    ...
    NumGlyphs = 2
    TabOrder = 15
    OnKeyPress = rxqte1KeyPress
  end
  object rxqte2: TRxCalcEdit
    Left = 312
    Top = 280
    Width = 73
    Height = 21
  ...
  object qrproduto: TZQuery
    ...
    object qrprodutoESTOQUE_FISCAL: TFloatField
    ...
    object qrprodutoMARKUP: TFloatField
      FieldName = 'MARKUP'
    end
    ...
    object qrprodutoCODFILIAL: TStringField
      FieldName = 'CODFILIAL'
      Size = 10
    end
    object qrprodutoESTOQUE_FISCAL_1: TFloatField
      FieldName = 'ESTOQUE_FISCAL_1'
    end
    object qrprodutoCFOP: TStringField
      FieldName = 'CFOP'
      Size = 5
    end
    object qrprodutoEST_DEP: TFloatField
      FieldName = 'EST_DEP'
    end
    object qrprodutoEST_EXP: TFloatField
      FieldName = 'EST_EXP'
    end
    object qrprodutoEST_CON: TFloatField
      FieldName = 'EST_CON'
    end
  end
  object fsproduto: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'CODFILIAL=CODFILIAL'
      'ESTOQUE_FISCAL_1=ESTOQUE_FISCAL_1'
      'CFOP=CFOP'
      'EST_DEP=EST_DEP'
      'EST_EXP=EST_EXP'
      'EST_CON=EST_CON')
  ...
  object fxproduto: TfrxReport
    ...
    ReportOptions.LastChange = 41141.683985092590000000
