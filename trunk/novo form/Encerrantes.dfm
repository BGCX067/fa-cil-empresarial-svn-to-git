object frmEncerrantes: TfrmEncerrantes
  Left = 238
  Top = 124
  BorderIcons = [biSystemMenu]
  Caption = 'Encerrantes Di'#225'rios'
  ClientHeight = 381
  ClientWidth = 937
  Color = clBtnFace
  ...
  object pficha: TFlatPanel
    ...
    object dtATual: TDateTimePicker
      Left = 75
      Top = 8
      Width = 113
      Height = 21
      Date = 41094.717429108790000000
      Time = 41094.717429108790000000
      Enabled = False
      TabOrder = 0
    end
    object grdEncerrantes: TDBAdvGrid
      Left = 8
      Top = 40
      Width = 921
      Height = 297
  ...
  object dsEncerrantes: TDataSource
    DataSet = qrEncerrantes
    Left = 224
    Top = 96
  end
  ...
  object qrult_encerrantes: TZQuery
    Connection = frmmodulo.Conexao
    SQL.Strings = (
      'select * from ult_encerrantes')
    Params = <>
    Left = 376
    Top = 168
    object qrult_encerrantesCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Required = True
    end
    object qrult_encerrantesDATA: TDateTimeField
      FieldName = 'DATA'
    end
    object qrult_encerrantesCOD_BICO: TIntegerField
      FieldName = 'COD_BICO'
    end
    object qrult_encerrantesABERTURA: TIntegerField
      FieldName = 'ABERTURA'
    end
    object qrult_encerrantesENCERRAMENTO: TIntegerField
      FieldName = 'ENCERRAMENTO'
    end
    object qrult_encerrantesQUANTIDADE: TFloatField
      FieldName = 'QUANTIDADE'
    end
    object qrult_encerrantesAFERICAO: TFloatField
      FieldName = 'AFERICAO'
    end
    object qrult_encerrantesPRECO: TFloatField
      FieldName = 'PRECO'
    end
    object qrult_encerrantesVALOR: TFloatField
      FieldName = 'VALOR'
    end
    object qrult_encerrantesCOD_PRODUTO: TIntegerField
      FieldName = 'COD_PRODUTO'
    end
    object qrult_encerrantesSITUACAO: TWideStringField
      FieldName = 'SITUACAO'
      Size = 1
    end
    object qrult_encerrantesATUALIZADO: TIntegerField
      FieldName = 'ATUALIZADO'
    end
  end
  object qrFecha: TZQuery
    Connection = frmmodulo.Conexao
    Params = <>
    Left = 368
    Top = 216
