object frmBaixaCredito: TfrmBaixaCredito
  Left = 128
  Top = 188
  Width = 636
  Height = 159
  BorderIcons = [biSystemMenu]
  Caption = 'Baixa Cr'#233'dito'
  Color = clBtnFace
  ...
  object pficha: TFlatPanel
    ...
    object rdebito: TRxCalcEdit
      ...
      ParentFont = False
      TabOrder = 3
      OnEnter = rdebitoEnter
      OnExit = rdebitoExit
      OnKeyPress = rdebitoKeyPress
    end
