object frmLivroLMC: TfrmLivroLMC
  Left = 237
  Top = 147
  BorderIcons = [biSystemMenu]
  Caption = 'LMC - Cadastro dos Livros'
  ClientHeight = 300
  ClientWidth = 590
  Color = clBtnFace
  ...
  object pficha: TFlatPanel
    ...
    object gbTermo: TGroupBox
      ...
      ParentColor = False
      TabOrder = 16
      object rdAbertura: TRadioButton
        Left = 16
        Top = 16
        Width = 113
        Height = 17
  ...
  object dsLivroLMC: TDataSource
    DataSet = frmmodulo.qrLivroLMC
    Left = 512
    Top = 160
  end
