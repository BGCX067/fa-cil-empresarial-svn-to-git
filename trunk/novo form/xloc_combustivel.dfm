object frmxloc_combustivel: Tfrmxloc_combustivel
  ...
  object GRID: TwwDBGrid
    ...
    Height = 312
    Selected.Strings = (
      'NOME'#9'30'#9'NOME'#9#9
      'PR_COMPRA'#9'10'#9'PR_COMPRA'#9'F'#9
      'PR_CUSTO'#9'10'#9'PR_CUSTO'#9'F'#9
      'PR_VENDA'#9'10'#9'PR_VENDA'#9'F'#9
  ...
  object query: TZQuery
    ...
    object queryPR_COMPRA: TFloatField
      DisplayWidth = 10
      FieldName = 'PR_COMPRA'
    end
    object queryPR_CUSTO: TFloatField
      DisplayWidth = 10
      FieldName = 'PR_CUSTO'
    end
    object queryPR_VENDA: TFloatField
      DisplayWidth = 10
      FieldName = 'PR_VENDA'
    end
