object frmContaFlex_Lancamento: TfrmContaFlex_Lancamento
  Left = 294
  Top = 208
  Width = 477
  Height = 228
  BorderIcons = []
  Caption = 'Conta Flex - Ficha de Lan'#231'amento'
  Color = clBtnFace
  ...
  object dsFlex: TDataSource
    DataSet = FrmContaFlex.qrContaFlex
    Left = 336
    Top = 24
  end
