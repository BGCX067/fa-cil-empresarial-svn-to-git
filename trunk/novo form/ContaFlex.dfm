object FrmContaFlex: TFrmContaFlex
  Left = 70
  Top = 98
  Width = 883
  Height = 441
  BorderIcons = []
  Caption = 'Lan'#231'amentos ContaFlex'
  Color = clBtnFace
  ...
  object qrContaFlex: TZQuery
    Connection = frmmodulo.Conexao
    CachedUpdates = False
    Active = True
    SQL.Strings = (
      'select * from CONTAFLEX')
    ParamCheck = True
    Params = <>
    ...
    Left = 376
    Top = 88
    object qrContaFlexVALOR: TFloatField
      DisplayWidth = 13
      FieldName = 'VALOR'
    end
    object qrContaFlexCODIGOVENDEDOR: TStringField
      FieldName = 'CODIGOVENDEDOR'
      Visible = False
      Size = 6
    end
    object qrContaFlexNUMEROMOVIMENTO: TStringField
      FieldName = 'NUMEROMOVIMENTO'
      Visible = False
      Size = 6
    end
    object qrContaFlexDATAMOVIMENTO: TDateTimeField
      FieldName = 'DATAMOVIMENTO'
      Visible = False
    end
    object qrContaFlexTIPOMOVIMENTO: TStringField
      FieldName = 'TIPOMOVIMENTO'
      Visible = False
      Size = 1
    end
  end
  object dsContaFlex: TDataSource
    DataSet = qrContaFlex
    Left = 408
    Top = 88
  end
