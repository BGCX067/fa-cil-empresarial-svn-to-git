object frmPedidoVend: TfrmPedidoVend
  Left = 107
  Top = 121
  Width = 920
  Height = 667
  ...
  object QuickRep1: TQuickRep
    ...
    object QRBand3: TQRBand
      ...
      object QRLabel32: TQRLabel
        ...
        AutoStretch = False
        Caption = 
          'Agradecemos pela oportunidade em fazer o seu pedido. Temos grand' +
          'e satisfa'#231#227'o em t'#234'-lo cliente.'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
      ...
      object QRLabel36: TQRLabel
        ...
        AutoStretch = False
        Caption = 
          'Esperamos poder realizar o seu sonho e continuar a atend'#234'-lo sem' +
          'pre bem.'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
  ...
  object qrTempPro: TZQuery
    Connection = frmmodulo.Conexao
    OnCalcFields = qrTempProCalcFields
    CachedUpdates = False
    SQL.Strings = (
      'select * from cl00001')
    ParamCheck = True
    ...
    Left = 458
    Top = 539
    object qrTempProITEM: TStringField
      FieldName = 'ITEM'
      Size = 3
    end
    object qrTempProCODPRODUTO: TStringField
      FieldName = 'CODPRODUTO'
      Size = 6
    end
    object qrTempProPRODUTO: TStringField
      FieldName = 'PRODUTO'
      Size = 80
    end
    object qrTempProCODBARRAS: TStringField
      FieldName = 'CODBARRAS'
      Size = 13
    end
    object qrTempProSERIAL: TStringField
      FieldName = 'SERIAL'
      Size = 30
    end
    object qrTempProNUMERACAO: TStringField
      FieldName = 'NUMERACAO'
      Size = 10
    end
    object qrTempProQTDE: TFloatField
      FieldName = 'QTDE'
    end
    object qrTempProUNITARIO: TFloatField
      FieldName = 'UNITARIO'
      DisplayFormat = '###,###,##0.00'
    end
    object qrTempProTOTAL: TFloatField
      FieldName = 'TOTAL'
      DisplayFormat = '###,###,##0.00'
    end
    object qrTempProDESCONTO: TFloatField
      FieldName = 'DESCONTO'
      DisplayFormat = '###,###,##0.00'
    end
    object qrTempProACRESCIMO: TFloatField
      FieldName = 'ACRESCIMO'
    end
    object qrTempProCODGRADE: TStringField
      FieldName = 'CODGRADE'
      Size = 6
    end
    object qrTempProTIPO: TIntegerField
      FieldName = 'TIPO'
    end
    object qrTempProALIQUOTA: TFloatField
      FieldName = 'ALIQUOTA'
    end
    object qrTempProCST: TStringField
      FieldName = 'CST'
      Size = 3
    end
    object qrTempProTERMINAL: TStringField
      FieldName = 'TERMINAL'
      Size = 4
    end
    object qrTempProCODSUBGRUPO: TStringField
      FieldName = 'CODSUBGRUPO'
      Size = 6
    end
    object qrTempProPISCOFINS: TStringField
      FieldName = 'PISCOFINS'
      Size = 1
    end
    object qrTempProSERIAL_CODINT: TStringField
      FieldName = 'SERIAL_CODINT'
      Size = 6
    end
    object qrTempProGRADE_CODINT: TStringField
      FieldName = 'GRADE_CODINT'
      Size = 6
    end
    object qrTempProNUMVENDA: TStringField
      FieldName = 'NUMVENDA'
      Size = 10
    end
    object qrTempProVALOR_LIQUIDO: TFloatField
      FieldKind = fkCalculated
      FieldName = 'VALOR_LIQUIDO'
      DisplayFormat = '###,###,##0.00'
      Calculated = True
