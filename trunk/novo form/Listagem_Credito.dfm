object frmListagemCredito: TfrmListagemCredito
  Left = 148
  Top = 107
  Width = 696
  Height = 480
  HorzScrollBar.Position = 89
  Caption = 'Listagem de Cr'#233'ditos'
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    object QRBand1: TQRBand
      ...
      object lbTitulo: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Listagem de Cr'#233'ditos Lan'#231'ados'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
    ...
    object QRBand4: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(qrCreditos.VALOR_PAGO)'
        Mask = '###,###,##0.00'
        ExportAs = exptText
        FontSize = 10
      end
  ...
  object qrCreditos: TZQuery
    ...
    Left = 136
    Top = 224
    object qrCreditosCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Required = True
    end
    object qrCreditosDATA_EMISSAO: TDateTimeField
      FieldName = 'DATA_EMISSAO'
    end
    object qrCreditosCODIGO_CLI: TStringField
      FieldName = 'CODIGO_CLI'
      Size = 6
    end
    object qrCreditosVALOR_ORIGINAL: TFloatField
      FieldName = 'VALOR_ORIGINAL'
    end
    object qrCreditosVALOR_ATUAL: TFloatField
      FieldName = 'VALOR_ATUAL'
      DisplayFormat = '###,###,##0.00'
    end
    object qrCreditosDATA_PAGAMENTO: TDateTimeField
      FieldName = 'DATA_PAGAMENTO'
    end
    object qrCreditosSITUACAO: TIntegerField
      FieldName = 'SITUACAO'
    end
    object qrCreditosNOME_CLI: TStringField
      FieldKind = fkLookup
      FieldName = 'NOME_CLI'
    ...
    object qrCreditosVALOR_PAGO: TFloatField
      FieldName = 'VALOR_PAGO'
    end
    object qrCreditosNOME: TStringField
      FieldName = 'NOME'
      Size = 50
    end
  end
  object qrClientes: TZQuery
    ...
    object qrClientesENDPAIMAE: TStringField
      FieldName = 'ENDPAIMAE'
      Size = 80
    end
  end
