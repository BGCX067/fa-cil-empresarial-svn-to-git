object frmLMC: TfrmLMC
  ...
  object qrTanques: TZQuery
    ...
    Left = 512
    Top = 48
    object qrTanquesCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Required = True
    end
    object qrTanquesCOD_PRODUTO: TIntegerField
      FieldName = 'COD_PRODUTO'
      Required = True
    end
    object qrTanquesCAP_MAXIMA: TIntegerField
      FieldName = 'CAP_MAXIMA'
      Required = True
    end
    object qrTanquesCAP_MINIMA: TIntegerField
      FieldName = 'CAP_MINIMA'
    end
    object qrTanquesNUMERO_FISICO: TIntegerField
      FieldName = 'NUMERO_FISICO'
      Required = True
    end
    object qrTanquesESTOQUE_INICIAL: TFloatField
      FieldName = 'ESTOQUE_INICIAL'
    end
    object qrTanquesESTOQUE_ATUAL: TFloatField
      FieldName = 'ESTOQUE_ATUAL'
    end
    object qrTanquesESTOQUE_MEDICAO: TFloatField
      FieldName = 'ESTOQUE_MEDICAO'
    end
    object qrTanquesVALOR_ENTRADA: TFloatField
      FieldName = 'VALOR_ENTRADA'
    end
    object qrTanquesVALOR_SAIDA: TFloatField
      FieldName = 'VALOR_SAIDA'
    end
    object qrTanquesDATA_ULT_ENT: TDateTimeField
      FieldName = 'DATA_ULT_ENT'
    end
    object qrTanquesDATA_ULT_SAI: TDateTimeField
      FieldName = 'DATA_ULT_SAI'
    end
    object qrTanquesNUMERO_NF: TWideStringField
      FieldName = 'NUMERO_NF'
      Size = 10
    end
  end
  object qrCombustiveis: TZQuery
    ...
    Left = 544
    Top = 48
    object qrCombustiveisNOME: TWideStringField
      FieldName = 'NOME'
      Size = 30
    end
    object qrCombustiveisPR_COMPRA: TFloatField
      FieldName = 'PR_COMPRA'
    end
    object qrCombustiveisPR_CUSTO: TFloatField
      FieldName = 'PR_CUSTO'
    end
    object qrCombustiveisPR_VENDA: TFloatField
      FieldName = 'PR_VENDA'
    end
  ...
  object qrApoio: TZReadOnlyQuery
    Connection = frmmodulo.Conexao
    Params = <>
    Left = 536
    Top = 88
