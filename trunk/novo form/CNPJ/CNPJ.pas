...
begin
 ...
 if EditCNPJ.Text  <> '' then
    begin
        ...
        begin
          if APPLICATION.MESSAGEBOX('Existe um cliente cadastrado com este CNPJ! Deseja cancelar esta ficha de cadastro e ir até a ficha deste cliente?', 'Atenção', mb_yesno + mb_iconwarning + MB_DEFBUTTON2) = idyes then
          begin
