object frmTranfEstoque: TfrmTranfEstoque
  Left = 276
  Top = 191
  Width = 519
  Height = 247
  ...
  object qrEstoque: TZQuery
    ...
    object qrEstoqueESTOQUE_FISCAL: TFloatField
      FieldName = 'ESTOQUE_FISCAL'
    end
    object qrEstoqueEST_DEP: TFloatField
      FieldName = 'EST_DEP'
    end
    object qrEstoqueEST_EXP: TFloatField
      FieldName = 'EST_EXP'
    end
    object qrEstoqueEST_CON: TFloatField
      FieldName = 'EST_CON'
    end
  end
