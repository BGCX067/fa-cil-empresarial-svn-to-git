...
begin
  frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração dos Blocos', False, True, 0);
  if FileExists(sPasta_sistema + '\txt\erro.txt') then
    DeleteFile(sPasta_sistema + '\txt\erro.txt');
  frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 0', False, True, 0);
  GerarBloco0;
  frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C', False, True, 0);
  GerarBlocoC;
  frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco E', False, True, 0);
  GerarBlocoE;

  if gerarInv.Checked then
  begin
    frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco H', False, True, 0);
    GerarBlocoH;
  end;
  frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 1', False, True, 0);
  GerarBloco1;
  ...
  Application.MessageBox(pchar(mensagem), 'Informação do Sistema', MB_OK +
    MB_ICONINFORMATION);
...
begin
  ...
  begin
    // Dados da Empresa
    frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 0 - Dados da Empresa', False, True, 0);
    ...
    begin
      ...
      frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 0 - Dados do contador', False, True, 0);
      ...
      frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 0 - Registro 0150', False, True, 0);
      query.Close;
      query.sql.clear;
      ...
      begin
        ...
        frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 0 - Registro 0150' + #13 +
        ...
        begin
          ...
          begin
            frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 0 - Registro 0150 Entradas', False, True, 0);
          ...
          begin
            frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 0 - Registro 0150 saidas', False, True, 0);
            qrApoio.Close;
            qrApoio.sql.clear;
            qrApoio.sql.add('select * from c000009 where codigo = :codigo');
            qrApoio.Params.ParamByName('codigo').AsString := scodpar;
          ...
          begin
            frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 0 - Registro 0150 Movimentos 99', False, True, 0);
            qrApoio.Close;
            qrApoio.sql.clear;
            qrApoio.sql.add('select * from c000009 where codigo = :codigo');
            qrApoio.Params.ParamByName('codigo').AsString := scodpar;
      ...
      frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 0 - Preparar Tabela reg_150', False, True, 0);
      ...
      frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 0 - 4 Unidades de medida', False, True, 0);
      ...
      frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 0 - select * from reg_190', False, True, 0);
      query.Close;
      query.sql.clear;
      ...
      frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 0 - Registro 0200', False, True, 0);
      query.Close;
      query.sql.clear;
      ...
      begin
        ...
        frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 0 - 0200' + #13 +
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          ALIQ_ICMS := query.fieldbyname('aliquota_icms').AsFloat;
            ...
            //REGISTRO 0206: CÓDIGO DE PRODUTO CONFORME PUBLICADA PELA ANP (COMBUSTÍVEIS)
      ...
      frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 0 - Cadastro de Natureza de Operação', False, True, 0);
      query.Close;
      query.sql.clear;
      ...
      begin
        ...
        begin
         ...
         {
      frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 0 - plano_contas_contabeis', False, True, 0);
      query.Close;
      query.sql.clear;
      ...
      begin
        ...
        {
      frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 0 - REGISTRO 0400', False, True, 0);
      query.Close;
      query.sql.clear;
  ...
  frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco 0 - Final', False, True, 0);
end;
...
begin
  ...
  frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - Inicio', False, True, 0);

  with ACBrSPEDFiscal1.Bloco_C do
  begin
    frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - Notas de ENTRADAS', False, True, 0);
    //Notas de ENTRADAS
    query.Close;
    query.sql.clear;
    ...
    begin
      ...
      begin
        IND_MOV := imComDados;
          // Notas de Entradas
        frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - C100', False, True, 0);
        while not query.eof do
        begin
          ...
          begin
            ...
            else if query.fieldbyname('transp_frete').asstring = '1 - Por conta do destinatário/remetente' then
            ...
            else if query.fieldbyname('transp_frete').asstring = '9 - Sem cobrança de frete' then
        ...
        //            ShowMessage(scodigonota);
                  {  Somente qdo atender as condições do Speed Fiscal }

          frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - C170', False, True, 0);
          ...
          frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - C190', False, True, 0);
...
//            for IItens := 1 to 10 do
    ...
    frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - Notas de SAIDAS', False, True, 0);
     //apuracao de icms
    //Notas de SAÍDA
    query.Close;
    query.sql.clear;
  ...
  //query.sql.add('data <= :data_fim order by data');
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C100 - Notas de SAIDAS', False, True, 0);
          with RegistroC100New do
          begin
          ...
          begin
            ...
            begin
              with RegistroC170new do
              begin
                frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C170 - Notas de SAIDAS', False, True, 0);
                NUM_ITEM := query2.fieldbyname('item').AsString;
                COD_ITEM := query2.fieldbyname('codproduto').AsString;
                DESCR_COMPL := query2.fieldbyname('produto').AsString;
                QTD := query2.fieldbyname('qtde').AsFloat;
          ...
          begin
            with RegistroC190New do
            begin
              frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C190 - Notas de SAIDAS', False, True, 0);
              CST_ICMS := query3.fieldbyname('cst').AsString;
              CFOP := query3.fieldbyname('cfop').AsString;
    ...
    frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - Notas de SAIDAS/Final', False, True, 0);
    ...
    frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - MODELO 02', False, True, 0);
    if Bloco_0.Registro0000.IND_PERFIL = pfPerfilB then
    begin
     //consulta com todas d1 por data
      frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C PERFILB - MODELO 02', False, True, 0);
      query.Close;
      query.sql.clear;
                  ...
                  //variaveis
                   ...
                   // ShowMessage('Inicio  ' + doc_ini + ' Final  ' + doc_fin);
                    ...
                    begin
                      ...
                      begin
                        frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C300 PERFILB - MODELO 02', False, True, 0);
                        //total por serie
                        //lancar d1
                        //Notas de SAÍDA    Agrupamento  nao computa o valor das canceladas
    ...
    //perfil A
    //14/01/2014 mizael correção para melhorar perfomance
    ...
    begin
      ...
      begin
        while not query.Eof do
        begin
          frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - MODELO 02 PERFIL A', False, True, 0);
    ...
    frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - REGISTRO C400 - EQUIPAMENTO ECF ', False, True, 0);
    qrECF.Close;
    qrECF.sql.clear;
    ...
    begin
      ...
      begin
        ...
        frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - REGISTRO C400 - sintegra_reg60', False, True, 0);
        ...
        begin
          ...
          frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - Registro C405', False, True, 0);
          ...
          begin
            ...
            begin
              if (qrPISCOFINS.fieldbyname('piscofins').asstring = 'S') and
                ...
                'Operação Tributável Monofásica - Revenda a Alíquota Zero') then
              begin
                stot_pis := stot_pis +
            ...
            frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - REGISTRO C410', False, True, 0);
            ...
            frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - REGISTRO C420', False, True, 0);
            ...
            frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - REGISTRO PERFILB', False, True, 0);
            //Gera este registro somente para empresas do pergil B de apresentação
            if Bloco_0.Registro0000.IND_PERFIL = pfPerfilB then
            begin
              frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - REGISTRO C425', False, True, 0);
              qrPISCOFINS.Close;
              qrPISCOFINS.SQL.Clear;
            ...
            frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - REGISTRO C460', False, True, 0);
            /// CUPONS FISCAIS
            qrCupom.close;
            qrcupom.sql.clear;
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  begin
                    ...
                    frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - REGISTRO C470', False, True, 0);
                    qrcupom_item.close;
                    ...
                    begin
                      ...
                      begin
                        frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - REGISTRO C470' + #13 +
              ...
              begin
                frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - CUPONS CANCELADOS', False, True, 0);
                if Bloco_0.Registro0000.IND_PERFIL <> pfPerfilB then
                begin
                  with REgistroC460New do
                  begin
            ...
            frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - REGISTRO C490', False, True, 0);
    ...
    frmPrincipal.Aguarde('SPED', 'Aguarde Iniciando a Geração do Bloco C - FINAL / EQUIPAMENTO ECF ', False, True, 0);

  end;
  frmPrincipal.Aguarde('SPED', 'Aguarde a Geração do Bloco C - Final', False, True, 0);
end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        IND_FORM := 'N';
        // INSERIDO PARA SE A FEREDEÇÃO FOR OBRIGATORIO A DOCUMENTO DE PAPEL CRIAR CAMPO NO CADASTRO DE EMITENTE E VARIAVEL (EMMANOEL)
        IND_AER := 'N';
        // E OBRIGATORIO SE A EMPRESA PRESTOU SERVIÇO DE TRASPORTES DE CARGA AREA. CRIAR NA TABELA ESSA MOVIMENTAÇÃO (EMMANOEL)
      end;
