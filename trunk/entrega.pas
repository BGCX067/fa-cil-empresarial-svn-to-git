...
uses
  ...
  ZDataset, Menus, frxClass, frxDBSet, frxDesgn, UCBase;
...
begin
  ...
  rel_entrega.Report.LoadFromFile('\Z5\server\rel\F000169.fr3');
...
begin
  ...
  rel_entrega.Report.LoadFromFile('\Z5\server\rel\F000171.fr3');
  rel_entrega.ShowReport;
