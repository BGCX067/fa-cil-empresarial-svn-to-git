...
begin
  ...
  PDF.DefaultPath := 'C:\Z5\Server\PDF\';
  PDF.ShowDialog := false;
  PDF.ShowProgress := false;
  PDF.OverwritePrompt := false;
  fxpedido.LoadFromFile('\Z5\server\rel\f000132_2.fr3');
  ...
  TIdAttachmentFile.create(EmailCorpo.MessageParts,
    Tfilename('C:\Z5\Server\PDF\' + DBEdit2.Text + '-' + DBEdit23.Text
    + '.pdf'));
...
begin
  ...
  fxpedido.LoadFromFile('\Z5\server\rel\f000132.fr3');
  fxpedido.ShowReport;
end;
