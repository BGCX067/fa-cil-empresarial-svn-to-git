...
procedure Tfrmxloc_produto.GRIDDrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
  ColorBgGridEstoque(Sender, Rect, DataCol, Column, State);
end;
