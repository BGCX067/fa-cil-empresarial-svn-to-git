...
uses
  ...
  frxDBSet, frxDesgn, Menus, AdvGlowButton, MemDS, DBAccess;
...
begin
  ...
  if combo_relatorio.ItemIndex = 0 then FXNOTA.LoadFromFile('\Z5\server\rel\f000190.fr3');
  if combo_relatorio.ItemIndex = 1 then FXNOTA.LoadFromFile('\Z5\server\rel\f000190_2.fr3');
...
begin
  ...
  begin
    FXNOTA.LoadFromFile('\Z5\server\rel\f000190.fr3');
    FXNOTA.DesignReport;
  end;
  if combo_relatorio.itemindex = 1 then
  begin
    FXNOTA.LoadFromFile('\Z5\server\rel\f000190_2.fr3');
    FXNOTA.DesignReport;
  end;
