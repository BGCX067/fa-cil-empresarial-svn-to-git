...
uses
  ...
  DBAccess,  frxClass, frxDBSet, frxDesgn, ZAbstractRODataset,
  ZAbstractDataset, ZDataset, AdvReflectionImage, Vcl.Menus;
...
begin
  ...
  relABC.LoadFromFile('\Z5\server\rel\f000195.fr3');
  relABC.ShowReport;
